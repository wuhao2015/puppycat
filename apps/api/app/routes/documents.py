...
@router.post("/itinerary", dependencies=[Depends(require_api_key)])
...
@router.post("/visa", dependencies=[Depends(require_api_key)])
...
@router.post("/cover-letter", dependencies=[Depends(require_api_key)])
